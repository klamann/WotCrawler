...
import wdc.ext.Field;
import wdc.ext.FieldDef;
import wdc.ext.ModuleMap;
import wdc.ext.TankRating;
...
public class Transformer {
     ...
     * the array.
     */
    protected String buildSingleModuleTable(List modules, Field[] fields) {
